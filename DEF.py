...
print(saludar()) # Nombre toma el valor desconocido (imprime Buenas tardes, señor DESCONOCIDO)
print(saludar("Pepe")) # Nombre toma el valor  Pepe (IMPRIME Buenas tardes, Señor PEPE)
